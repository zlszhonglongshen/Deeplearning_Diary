...
class labelme2coco(object):
    def __init__(self, labelme_json=[], save_json_path='./new.json'):
        ...
        self.categories = [{'supercategory': 'zheng', 'id': 1, 'name': 'zheng'},
                           {'supercategory': 'fan', 'id': 2, 'name': 'fan'}]
...
labelme_json = glob.glob('C:/Users/Johnson/Desktop/idcard-version-03/json/*.json')

labelme2coco(labelme_json, 'C:/Users/Johnson/Desktop/idcard-version-03/new.json')